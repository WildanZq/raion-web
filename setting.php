...
<body>
    ...
    <div class="width-controller height-controller p-0 px-md-3 mx-4 mx-lg-5 pt-5 d-flex justify-content-center align-items-center login">
        <div class="card">
            <div class="card-body">
                <h1 class="h4 mb-3 text-center text-primary">Ganti Password</h1>
                <form action="./php/user/change-password.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="password-new" id="password-new" required minlength="6">
                    </div>
                    <div class="form-group">
                        <label for="password-confirm">Konfirmasi Password Baru</label>
                        <input class="form-control" type="password" name="password-confirm" id="password-confirm" required minlength="6">
                    </div>
                    <button class="btn btn-secondary w-100" type="submit">Ganti</button>
                </form>
            </div>
        </div>
    </div>
